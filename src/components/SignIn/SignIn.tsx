...
import { Container, makeStyles, Typography, Snackbar } from '@material-ui/core';
...
const useStyles = makeStyles({
    ...
    typographyStyle: {
        fonFamily: 'Robot, arial, sans-serif',
        textAlign: 'center',
        fontSize: '2em',
    },
    containerStyle: {
    ...
    return (
        <div>
            ...
            <Container maxWidth = 'sm' className={classes.containerStyle}>
                <Typography className={classes.typographyStyle}>Basketball Enthusiast Sign In</Typography>
                <form>
                    <div>
